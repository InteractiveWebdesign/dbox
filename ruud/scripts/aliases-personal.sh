...
alias dvl-start="docker compose -f $DIR/../../docker-compose.yml -f $DIR/../../docker-compose.rw.yml --project-directory=$DIR/../../ start -d php php71 php74 mysql httpd bind elastic mailhog redis"
